...
function ProjectCard({ project }) {
  return (
    <article className="group overflow-hidden rounded-[2rem] border border-black/10 bg-white/55 shadow-sm backdrop-blur transition hover:-translate-y-1 hover:bg-white hover:shadow-xl hover:shadow-black/10">
      {project.video && (
        <video
          key={project.video}
          src={project.video}
      ...
      <a href={project.url || "#work"} target="_blank" rel="noopener noreferrer" className="block h-full p-5 sm:p-6">
          ...
          <div className="mx-auto grid min-h-[calc(100vh-7rem)] max-w-7xl items-center gap-10 sm:gap-12 md:min-h-[calc(100vh-8rem)] md:grid-cols-[1.2fr_0.8fr]">
            <div>
              ...
              <h1 className="max-w-5xl text-5xl font-semibold leading-[0.92] tracking-[-0.07em] text-black sm:text-6xl md:text-8xl md:leading-[0.9] lg:text-9xl">
                Innovación visual para marcas que quieren moverse más rápido.
              </h1>

              <p className="mt-6 max-w-2xl text-base leading-7 text-black/70 sm:mt-8 sm:text-lg sm:leading-8 md:text-xl">
                En EMEGE diseñamos portfolios, webs, apps, sistemas visuales y rebrandings con tecnología IA, criterio estratégico y una estética digital limpia, actual y altamente diferenciadora.
              </p>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="rounded-2xl border border-white/10 bg-white/10 p-4">
                        ...
                        <p className="text-sm text-white/50">Prototipos web/app</p>
                      </div>
                      <div className="rounded-2xl border border-lime-300/30 bg-lime-300 p-4 text-black">
                        <Palette size={22} />
                        <p className="mt-8 text-3xl font-semibold">06</p>
                        <p className="text-sm text-black/60">Rebrandings</p>
                      </div>
                    </div>
                  </div>
                </div>
